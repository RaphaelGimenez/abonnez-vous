...
class StripeService
{
	...
	public function handleCustomerSubscriptionUpdated(mixed $subscription): void
	{
		...
		if ($subscriptionEntity) {
			...
			$subscriptionEntity->setCancellationReason($subscription->cancellation_details->reason ?? null);
			$subscriptionEntity->setCancelAt(
				isset($subscription->cancel_at) ? (new \DateTimeImmutable())->setTimestamp($subscription->cancel_at) : null
			);
