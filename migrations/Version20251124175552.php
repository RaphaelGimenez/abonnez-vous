 ...
 */
final class Version20251124175552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscription ADD COLUMN billing_period VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__subscription AS SELECT id, status, start_date, end_date, auto_renew, user_id, plan_id FROM subscription');
        ...
        $this->addSql('INSERT INTO subscription (id, status, start_date, end_date, auto_renew, user_id, plan_id) SELECT id, status, start_date, end_date, auto_renew, user_id, plan_id FROM __temp__subscription');
